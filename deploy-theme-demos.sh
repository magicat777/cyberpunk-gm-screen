...
# This script commits and pushes the theme demos to GitHub Pages
# Run this script from your WSL home directory
# Usage: bash deploy-theme-demos.sh YOUR_GITHUB_TOKEN

if [ -z "$1" ]; then
  echo "Please provide your GitHub personal access token"
  echo "Usage: bash deploy-theme-demos.sh YOUR_GITHUB_TOKEN"
  exit 1
fi
...
echo "Deploying cyberpunk theme demos to GitHub Pages..."
...
cp "$MAIN_REPO/css/modernized/themes-demo.html" .
